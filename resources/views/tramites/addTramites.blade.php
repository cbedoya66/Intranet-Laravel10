...
@section('content')
    <h4>Ingrese la información para el Trámite del usuario.</h4>
    <?php
        if (session()) {
            ...
            <form action="{{ route('tramite.store') }}" method="POST">
                ...
                <div class="row">
                    ...
                    <div class="col-3"><x-adminlte-input name="intcedula" id="intcedula" type="text" label="Cédula"
                            placeholder="Cédula" label-class="text-lightblue" value="{{ $registro->id }}">
                            <x-slot name="prependSlot">
                                <div class="input-group-text">
                    ...
                    <div class="col-6"><x-adminlte-input name="strnombres" id="strnombres" type="text" label="Nombre"
                            placeholder="Nombre" label-class="text-lightblue" value="{{ $registro->strnombres }}">
                            <x-slot name="prependSlot">
                                <div class="input-group-text">
                ...
                <div class="row">
                    ...
                    <div class="col-3"><x-adminlte-input name="strsector" id="strsector" type="text" label="Sector"
                            placeholder="Sector" label-class="text-lightblue" value="{{ $registro->strsector }}">
                            <x-slot name="prependSlot">
                                <div class="input-group-text">
                    ...
                    <div class="col-3"><x-adminlte-select2 name="strnacionalidad" id="strnacionalidad" label="Nacionalidad"
                            ...
                            <option>{{ $registro->strnacionalidad }}</option>
                ...
                <div class="row">
                    ...
                    <div class="col-3">
                        <x-adminlte-input name="entidad" id="entidad" type="text" label="Entidad"
                            ...
                            <x-slot name="prependSlot" value="{{ $registro->entidad }}">
                                <div class="input-group-text">
                    ...
                    <div class="col-2">
                        <x-adminlte-input name="edad" id="edad" type="text" label="Edad"
                            placeholder="Edad" label-class="text-lightblue" value="{{ $registro->edad }}">
                            <x-slot name="prependSlot">
                                <div class="input-group-text">
                ...
                <div class="row">
                    <div class="col-6">
                        <x-adminlte-textarea name="strobservaciones" id="strobservaciones" label="Observaciones" rows=5
                            ...
                            {{ $registro->strobservaciones }}
                        </x-adminlte-textarea>

                    </div>
                    <div class="col-3">
                        <x-adminlte-input name="email" id="email" type="email" label="Email"
                            placeholder="Email" label-class="text-lightblue" value="{{ $registro->email }}">
                            <x-slot name="prependSlot">
                                <div class="input-group-text">
