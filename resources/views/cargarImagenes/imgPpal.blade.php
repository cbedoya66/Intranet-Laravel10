...
@section('content')
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ route('imgPpal.store') }}" method="POST" enctype="multipart/form-data">
                @csrf

                <div class="row">

                    <div class="col-6">
                        <h6>Carga Imagen con el nombre y la extención siguiente "personeria.png"</h6>
