...
@section('content_header')
    <h1 style="text-align: center">Rádicados Recibidos</h1>
@stop
...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            <x-adminlte-button label="Nuevo Radicado Recibido" theme="success" icon="fas fa-key" class="float-right"
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-12">
                    ...
                    <form action="{{ url('recibido/reporte') }}" method="post">
                        @csrf
                        <div class="row">
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <form action="{{ url('recibido/reporteAbogado') }}" method="post">
                        @csrf
                        <div class="row">
    ...
    <p>Bienvenido al panel de Rádicados Recibidos</p>
    <div class="card">
        <div class="card-body">
    ...
    <!--ADICIONAR RADICADOS -->
    <x-adminlte-modal id="modalPurpleA" title="Adicionar Radicado Recibido" theme="success" icon="fas fa-bolt"
        size='lg' disable-animations>
        <form action="{{ route('recibido.store') }}" method="POST">
            @csrf
            <div class="row">
        ...
        <div class="card">
            <div class="card-body">
                <form action="{{ url('recibido/codBarras') }}" method="post" target="_blank">
                    @csrf
                    <div class="row">
                        <div class="col-6">
                            <x-adminlte-input name="codbarrec" id="codbarrec" type="text"
                                placeholder="Código de barras" label-class="text-lightblue"
                                value="<?php echo date('YmdHi'); ?>{{ $nroRadicado + 1 }}">
                                <x-slot name="prependSlot">
                                    <div class="input-group-text">
