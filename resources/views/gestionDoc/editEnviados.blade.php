...
@section('content_header')
    <h1>RADICADOS ENVIADOS</h1>
@stop

@section('content')
    <p>Actualización de Radicados Enviados</p>

    <div class="card">

        <div class="card-body">
            <form action="{{ route('enviado.update', $radEnviadosE) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="row">
                    <div class="col-4"><x-adminlte-input name="fecha" type="date" label="fecha" placeholder="Fecha"
                            label-class="text-lightblue" value="{{ $radEnviadosE->fecha }}">
                    ...
                    <div class="col-4"><x-adminlte-input name="nroRadicado" id="nroRadicado" type="text"
                            ...
                            label-class="text-lightblue" value="{{ $radEnviadosE->nroRadicado }}" readonly>
                            <x-slot name="prependSlot">
                                <div class="input-group-text">
                    ...
                    <div class="col-4"><x-adminlte-input name="nroRadInicial" id="nroRadInicial" type="text"
                            ...
                            label-class="text-lightblue" value="{{ $radEnviadosE->nroRadInicial }}">
                            <x-slot name="prependSlot">
                                <div class="input-group-text">
                ...
                <div class="row">
                    ...
                    <div class="col-5"><x-adminlte-input name="dependencia" id="dependencia" type="text"
                            ...
                            value="{{ $radEnviadosE->dependencia }}">
                            <x-slot name="prependSlot">
                                <div class="input-group-text">
                    ...
                    <div class="col-5"><x-adminlte-input name="encargado" id="encargado" type="text" label="Encargado"
                            placeholder="Encargado" label-class="text-lightblue" value="{{ $radEnviadosE->encargado }}">
                            <x-slot name="prependSlot">
                                <div class="input-group-text">
                                    <i class="fa fa-home text-lightblue"></i>
                                </div>
                ...
                <div class="row">
                    <div class="col-8">
                        <x-adminlte-select2 name="abogado" id="abogado" label="Profesional" label-class="text-lightblue"
                            ...
                            <option>{{ $radEnviadosE->abogado }}</option>
                    ...
                    <div class="col-4"><x-adminlte-input name="anexo" id="anexo" type="text" label="Anexo"
                            placeholder="Anexo" label-class="text-lightblue" value="{{ $radEnviadosE->anexo }}">
                            <x-slot name="prependSlot">
                                <div class="input-group-text">
                ...
                <div class="row">
                    <div class="col-4">
                        <x-adminlte-select2 name="respuesta" id="respuesta" label="Requiere Respuesta"
                            ...
                            <option>{{ $radEnviadosE->rRespuesta }}</option>
                    ...
                    <div class="col-4">
                        <x-adminlte-input name="radRespuesta" id="radRespuesta" type="text"
                            ...
                            <x-slot name="prependSlot" value="{{ $radEnviadosE->radRespuesta }}">
                                <div class="input-group-text">
                    ...
                    <div class="col-4">
                        <x-adminlte-input name="fecRespuesta" id="fecRespuesta" type="text" label="Fecha Respuesta"
                            ...
                            value="{{ $radEnviadosE->fecRespuesta }}">
                            <x-slot name="prependSlot">
                                <div class="input-group-text">
                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        ...
                        <x-adminlte-input accept="application/pdf" name="strArchivo" type="file" label="Archivo"
                            label-class="text-lightblue" value="{{ $radEnviadosE->strArchivo }}">
                            <x-slot name="prependSlot">
                                <div class="input-group-text">
                                    <i class="fa fa-home text-lightblue"></i>
                                </div>
